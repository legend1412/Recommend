...
class ChurnPredWithLR:
    ...
    def train_model(self):
        ...
        x_columns = [x for x in self.train.columns if x not in [lable, customerid]]
    ...
    def evaluate(self, lr, type):
        ...
        lable = 'Churn'
        customerid = 'customerID'
        x_columns = [x for x in self.test.columns if x not in [lable, customerid]]
...
if __name__ == '__main__':
    ...
    pred.evaluate(lr_result, type=1)
