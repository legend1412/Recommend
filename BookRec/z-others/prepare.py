...
class Prepare:
    def __init__(self):
        self.file = 'E:/initdata/books/豆瓣图书.xls'
    ...
    def transform(self):
        ...
        for row in self.data.iterrows():
            ...
            price = random.randint(20, 50) + random.randrange(1, 10) / 10 if row[1]["价格"] != row[1]["价格"] else row[1][
                "价格"]
            ...
            socre = random.randint(1, 9) + random.randrange(1, 10) / 10 if row[1]["评分"] != row[1]["评分"] else row[1][
                "评分"]
